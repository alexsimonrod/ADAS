...
#train_images_dir = '/scratch/tfg-adas/datasets/deepdrive/images/bdd100k/images/100k/train'
train_images_dir = '/scratch/tfg-adas/datasets/deepdrive/bdd_to_yolo/train'
# Here we need the directory of the validation images
val_images_dir = '/scratch/tfg-adas/datasets/deepdrive/images/bdd100k/images/100k/val'
